...
router.get('/auth/page', AuthController.getPage)
...
router.delete('/auth/operation', AuthController.deleteOperation)
...
router.get('/auth/user', AuthController.getUserDetail)
